...
heatliste = [
    ...
    { "lopsklasse": "G16", "index": "G16FA", "runde": "Finale A", "starttid": "09:30", "resultat_registrert": False,},
]

# TODO: objektet bør leses fra csv fil.
# TODO: loperlisten skal kun lopere i gjeldene klubb hvis valgt.
loperliste = [
    { "heat": "MJSA1", "pos": "1", "nr": "28", "navn": "Lars Michael Saab", "klubb": "Njård", "plass": "1", "videre_til": "FA-1", },
    { "heat": "MJSA1", "pos": "2", "nr": "29", "navn": "Ole H", "klubb": "Lyn", "plass": "2", "videre_til": "FA-2", },
